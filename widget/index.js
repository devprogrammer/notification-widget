...
exports.Axios = Axios;
},{"./lib/axios.js":"nUiQ"}],"WyUo":[function(require,module,exports) {
"use strict";
...
},{"axios":"dZBD"}],"L5Jg":[function(require,module,exports) {
"use strict";
...
const getNotification = name => {
  return _http.default.get("/social-proof-campaign/get-notification/".concat(name));
};
exports.getNotification = getNotification;
},{"../http":"WyUo"}],"b1TK":[function(require,module,exports) {
module.exports = "/company_logo.7b1ca96d.png";
...
var _getInfo = require("./utils/api/getInfo");
var _company_logo = _interopRequireDefault(require("./assets/imgs/company_logo.png"));
require("./App.css");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function App(props) {
  const {
  ...
  const fetchNotification = async () => {
    const res = await (0, _getInfo.getNotification)("r");
    const {
      data
    } = res.data;
    const {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, notifications && notifications.length > 0 && (notifications === null || notifications === void 0 ? void 0 : notifications.map((n, i) => {
    if (!n.status) return /*#__PURE__*/React.createElement("div", {
      className: "flex justify-between border border-1 shadow rounded-full gap-[12px] p-[4px] mt-[16px]",
      key: i
    }, /*#__PURE__*/React.createElement("img", {
      src: _company_logo.default,
    ...
    }, n.type.toUpperCase()), /*#__PURE__*/React.createElement("p", {
      className: "truncate size-[14px]"
    }, (n === null || n === void 0 ? void 0 : n.msg) || "VISITORS: ".concat(n === null || n === void 0 ? void 0 : n.message_visitors)), /*#__PURE__*/React.createElement("p", {
      className: "truncate font-[600] text-[12px]"
    }, "BY www.mymanager.com")));
  })));
}
var _default = exports.default = App;
},{"react":"n8MK","./utils/api/getInfo":"L5Jg","./assets/imgs/company_logo.png":"b1TK","./App.css":"vKFU"}],"FheM":[function(require,module,exports) {
var bundleURL = null;
...
},{"_bundle_loader":"TUK3","web-vitals":[["web-vitals.72e5e7d3.js","f6pS"],"web-vitals.72e5e7d3.js.map","f6pS"]}],"Focm":[function(require,module,exports) {
"use strict";
...
//   </React.StrictMode>
// );
const root = _client.default.createRoot(document.getElementById('gamestop'));
...
root.render( /*#__PURE__*/_react.default.createElement(_react.default.StrictMode, null, /*#__PURE__*/_react.default.createElement(_App.default, {
  symbol: widgetDiv === null || widgetDiv === void 0 ? void 0 : widgetDiv.dataset.symbol
})));
